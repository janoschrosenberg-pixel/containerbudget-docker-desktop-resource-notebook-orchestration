...
<div align="center">
  <img src="./public/logo.svg" alt="ContainerBudget — Docker Desktop — Orchestration" width="64" height="64">
  <h1>ContainerBudget — Docker Desktop — Orchestration</h1>
</div>

An independent project specification for Docker Desktop, covering container workload inventory, resource limit worksheets, volume backup checklist.
...
<img src="./public/screenshots/desktop-main.svg" alt="Docker Desktop — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Docker Desktop — compact concept, not a screenshot" width="250">
<br>
...
- **Container workload inventory** — planned module; not implemented.
- **Resource limit worksheets** — planned module; not implemented.
- **Volume backup checklist** — planned module; not implemented.

The proposed workflow separates container workload inventory from resource limit worksheets, with volume backup checklist retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Container workload inventory**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="ContainerBudget — Docker Desktop — Orchestration — specification review workflow">
<br>
...
### Container workload inventory

Define the input and expected outcome for module 1. Record the Docker Desktop version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Resource limit worksheets

Define the input and expected outcome for module 2. Record the Docker Desktop version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Volume backup checklist

Define the input and expected outcome for module 3. Record the Docker Desktop version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Container workload inventory |
